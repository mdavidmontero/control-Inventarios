...
export const TableKardexPunto = ({ data }) => {
  const deleteKardexPunto = useKardexPuntoStore(
    (state) => state.deleteKardexPunto
  );
  ...
  const eliminar = (p) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        await deleteKardexPunto({ id: p.id });
      }
    });
  };
  const columns = [
